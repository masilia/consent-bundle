...
class CategoryAdminController extends AbstractController
{
    ...
    public function edit(Request $request, CookieCategory $category): Response
    {
        ...
        if ($category->isAutoGenerated()) {
            $this->addFlash('error', 'Cannot edit auto-generated categories from third-party services.');
    ...
    public function delete(Request $request, CookieCategory $category): Response
    {
        ...
        if ($category->isAutoGenerated()) {
            $this->addFlash('error', 'Cannot delete auto-generated categories from third-party services.');
